        ...
        <section class="products-grid">
            <div class="product-card">
                ...
                <div class="product-info">
                    <h3 class="product-title">Casual Cotton Shorts</h3>
                    ...
                    <button class="add-to-cart" onclick="addToCart('Casual Cotton Shorts', 2499, 'img2/c1.jpeg')">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Sports Running Shorts', 1999, 'img2/c2.jpeg')">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Classic Denim Shorts', 2999, 'img2/c3.jpeg')">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Beach Swim Shorts', 1799, 'img2/c4.jpeg')">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Casual Chino Shorts', 1499, 'img2/c5.jpeg')">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
