...
<body>
    ...
    <main class="main-content">
        <section class="category-hero">
            <img src="women_img/shirt2.jpg" alt="Women's Shirts Collection" class="hero-image">
        ...
        <section class="products-grid">
            <div class="product-card">
                <img src="women_img/shirt2.jpg" alt="Casual Shirt" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Floral Print Shirt', 1999, 'women_img/shirt2.jpg', 1)">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="women_img/shirt2.jpg" alt="Formal Shirt" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Classic White Shirt', 1499, 'women_img/shirt2.jpg', 2)">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="women_img/shirt2.jpg" alt="Printed Shirt" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Striped Button-Down', 2299, 'women_img/shirt2.jpg', 3)">Add to Cart</button>
                </div>
            </div>
            ...
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Denim Shirt', 2799, 'women_img/shirt2.jpg', 4)">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
