...
<body>
    ...
    <main class="main-content">
        <section class="category-hero">
            <img src="women_img/sa2.jpeg" alt="Women's Sarees Collection" class="hero-image">
        ...
        <section class="products-grid">
            <div class="product-card">
                <img src="women_img/sa1.jpeg" alt="Silk Saree" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Banarasi Silk Saree', 12999, 'women_img/sa1.jpeg')">Add to Cart</button>
                </div>
            </div>
            <div class="product-card highlighted">
                <span class="highlight-badge">Featured</span>
                <img src="women_img/sa2.jpeg" alt="Kanjivaram Saree" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Kanjivaram Silk Saree', 15999, 'women_img/sa2.jpeg')">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="women_img/sa3.jpg" alt="Chanderi Saree" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Chanderi Cotton Saree', 8999, 'women_img/sa3.jpg')">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                <img src="women_img/sa4.jpg" alt="Tussar Saree" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Tussar Silk Saree', 10999, 'women_img/sa4.jpg')">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
