...
<body>
    ...
    <main class="main-content">
        <section class="category-hero">
            <img src="women_img/dw1.jpeg" alt="Women's Dresses Collection" class="hero-image">
        ...
        <section class="products-grid">
            <div class="product-card">
                <img src="women_img/dw1.jpeg" alt="Floral Maxi Dress" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Floral Maxi Dress', 4999, 'women_img/dw1.jpeg')">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="women_img/dw2.jpeg" alt="Little Black Dress" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Little Black Dress', 3499, 'women_img/dw2.jpeg')">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="women_img/dw3.jpeg" alt="Summer Sundress" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Summer Sundress', 2999, 'women_img/dw3.jpeg')">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="women_img/dw4.jpeg" alt="Cocktail Dress" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Cocktail Dress', 5499, 'women_img/dw4.jpeg')">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
