...
<body>
    ...
    <main class="main-content">
        <section class="category-hero">
            <img src="women_img/jaw1.jpeg" alt="Women's Jackets Collection" class="hero-image">
        ...
        <section class="products-grid">
            <div class="product-card">
                <img src="women_img/jaw1.jpeg" alt="Leather Jacket" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Classic Leather Jacket', 6999, 'women_img/jaw1.jpeg')">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="women_img/jaw2.jpeg" alt="Denim Jacket" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Casual Denim Jacket', 4499, 'women_img/jaw2.jpeg')">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="women_img/jaw3.jpeg" alt="Bomber Jacket" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Stylish Bomber Jacket', 3999, 'women_img/jaw3.jpeg')">Add to Cart</button>
                </div>
            </div>

            <div class="product-card">
                <img src="women_img/jaw4.jpeg" alt="Blazer" class="product-image">
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Professional Blazer', 5499, 'women_img/jaw4.jpeg')">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
