        ...
        <section class="products-grid">
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Sports T-Shirt', 999, 'img2/tshirt2m.jpg', 1)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Casual T-Shirt', 1299, 'img2/tshirt3m.jpg', 2)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Graphic T-Shirt', 1199, 'img2/tshirt4m.jpg', 3)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Printed T-Shirt', 899, 'img2/tshirt5m.jpg', 4)">Add to Cart</button>
                </div>
            </div>
            <div class="product-card">
                ...
                <div class="product-info">
                    ...
                    <button class="add-to-cart" onclick="addToCart('Performance T-Shirt', 1499, 'img2/tshirt6m.jpg', 5)">Add to Cart</button>
                </div>
            </div>
        </section>
    </main>
